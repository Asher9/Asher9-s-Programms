-- pastebin run -f  [-f] name repo tree [link [sha]]
-- from Asher9
...
function Funktion.Hilfe()
    ...
    print()
    print([==[Beispiele:]==])
    print([==[github Asher9 Asher9-s-Programms master Stargate-Programm]==])
    ...
    print([==[2) loadfile("/bin/pastebin.lua")("-f", "run", "rmWVAGLM", name:string, repo:string, tree:string[, link:string[, sha:string]])]==])
end
...
local function main()
    ...
    if hilfe then
        ...
        local a = "https://raw.githubusercontent.com/Asher9/Asher9-s-Programms/master/GitHub-Downloader/"
