...
function f.Pfad(versionTyp)
  if type(versionTyp) ~= "string" then
    return "https://raw.githubusercontent.com/Asher9/Asher9-s-Programms/master/openDHD/"
  elseif versionTyp == "beta" then
    return "https://raw.githubusercontent.com/Asher9/Asher9-s-Programms/openDHD/openDHD/"
  else
    return "https://raw.githubusercontent.com/Asher9/Asher9-s-Programms/" .. versionTyp .. "/openDHD/"
  end
end
...
function f.checkDateien()
  ...
  d:write('   loadfile("/bin/wget-lua")("-f", "https://raw.githubusercontent.com/Asher9/Asher9-s-Programms/master/GitHub-Downloader/github.lua", "/bin/github.lua")\n')
  d:write('   loadfile("/bin/github.lua")("Asher9", "Asher9-s-Programms", "master", "openDHD")\n')
  d:write('end\n')
  d:close()
  local dateien = {
