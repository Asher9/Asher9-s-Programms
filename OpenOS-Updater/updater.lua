-- pastebin run -f Uv3Cj0Yp
-- from Asher9
-- https://github.com/Asher9/Asher9-s-Programms

--[[
loadfile("/bin/wget.lua")("-f", "https://raw.githubusercontent.com/Asher9/Asher9-s-Programms/master/GitHub-Downloader/github.lua", "/bin/github.lua")
...
function Funktion.Pfad(api)
    if api then
        ...
        return "https://raw.githubusercontent.com/MightyPirates/OpenComputers/tree/master-MC1.10/src/main/resources/assets/opencomputers/loot/openos"
    end
end
...
local function main()
    ...
    if wget("-f", Funktion.Pfad(true), "/github-liste.txt") and wget("-f", "https://raw.githubusercontent.com/Asher9/Asher9-s-Programms/master/OpenOS-Updater/json.lua", "/json.lua") then
