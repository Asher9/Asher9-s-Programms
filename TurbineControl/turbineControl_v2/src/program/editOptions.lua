...
function createAllButtons()
  ...
  if lang == "de" then
    ...
    touch3:add("Zurück",backToMainMenu,3,13,19,13)
    ...
    touch4:add("Zurück",backToMainMenu,3,13,19,13)
...
function backToMainMenu()
  ...
  if math.floor(tonumber(optionList["reactorOffAt"])) ~= math.floor(reactorOffAt) then
    if lang == "de" then
      mon.write("Reaktor aus bei über "..math.floor(tonumber(optionList["reactorOffAt"])).."% -> "..math.floor(reactorOffAt).."%   ")
    elseif lang == "en" then
      mon.write("Reactor off above "..math.floor(tonumber(optionList["reactorOffAt"])).."% -> "..math.floor(reactorOffAt).."%   ")
    end
  else
    if lang == "de" then
      mon.write("Reaktor aus bei über "..math.floor(reactorOffAt).."%   ")
    elseif lang == "en" then
...
function setBackground()
  ...
  if lang == "de" then
    mon.write("-- Hintergrundfarbe ändern --")
