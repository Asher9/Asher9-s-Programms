...
function checkPeripherals()
    ...
    if t[0] == nil then
        if lang == "de" then
            mon.write("Turbinen nicht gefunden! Bitte prüfen und den Computer neu starten (Strg+R gedrückt halten)")
            error("Turbinen nicht gefunden! Bitte prüfen und den Computer neu starten (Strg+R gedrückt halten)")
        elseif lang == "en" then
    ...
    if r == "" then
        if lang == "de" then
            mon.write("Reaktor nicht gefunden! Bitte prüfen und den Computer neu starten (Strg+R gedrückt halten)")
            error("Reaktor nicht gefunden! Bitte prüfen und den Computer neu starten (Strg+R gedrückt halten)")
        elseif lang == "en" then
    ...
    if v == "" then
        if lang == "de" then
            mon.write("Energiespeicher nicht gefunden! Bitte prüfen und den Computer neu starten (Strg+R gedrückt halten)")
            error("Energiespeicher nicht gefunden! Bitte prüfen und den Computer neu starten (Strg+R gedrückt halten)")
        elseif lang == "en" then
            ...
            if targetLevel < 0 or targetLevel == "-inf" then
                ...
                if failCounter > 2 then
                    ...
                    if lang == "de" then
                        ...
                        mon.write("Berechnung wäre < 0!")
                        mon.setCursorPos(1, 3)
                        mon.write("Bitte Steam/Wasser-Input prüfen!")
                    elseif lang == "en" then
...
function createAllButtons()
    ...
    --Other buttons
    if lang == "de" then
        page:add("Hauptmenu", function() run("/reactor-turbine-program/start/menu.lua") end, 2, 23, 17, 23)
        --In Englisch
    elseif lang == "en" then
