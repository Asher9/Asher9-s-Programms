...
if not update then
  ...
  term.clear()
  term.setCursorPos(1,1)
  print("Reaktor- und Turbinenprogramm von Asher9")
  print("Version 2.6")
  print()
  print("Über das Programm:")
  print("Das Programm kontrolliert einen BigReactors-Reaktor.")
  print("Es können auch bis zu 32 Turbinen angeschlossen werden.")
  print("Der Computer muss mit Wired Modems am Reaktor (und ggf. Turbinen) verbunden werden.")
  print("Außerdem muss ein Energiespeicher und ein Monitor angeschlossen werden.")
  print("Der Monitor muss min. 7 Blöcke breit und 4 Bloecke hoch sein.")
  print("Wird das Programm mit Turbinen betrieben, sollte der Reaktor pro Turbine mindestens 2000mb/t Steam produzieren können.")
  print()
  write("Bitte Enter drücken...")
  leer = read()
  ...
  while out2 do
    term.clear()
    term.setCursorPos(1,1)
    print("Es wird empfohlen das Programm zum Startup hinzuzufügen.")
    print("Dadurch wird das Programm beim Starten des Computers automatisch ausgeführt.")
    term.write("Startup hinzufügen? (j/n): ")
...
print("Checke und lösche vorhandene Programme...")
